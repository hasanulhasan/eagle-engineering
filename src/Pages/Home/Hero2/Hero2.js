    ...
    <div className='my-10'>
      <section className="dark:bg-gray-800 dark:text-gray-100">
        <div className="container flex flex-col mx-auto lg:flex-row">
          ...
          <div className="flex flex-col w-full p-6 lg:w-2/3 md:p-8 lg:px-8 lg:py-12">
            ...
            <h2 className="text-3xl font-semibold leading-none">Hire Our Best Engineers for your service and Consultancy</h2>
